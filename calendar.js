...
courseForm.addEventListener('submit', e => {
	e.preventDefault();
	console.table(courseTitle.value, courseDescription.value, moment(new Date(courseStartDate.value)).format(), moment(new Date(courseEndDate.value)).format(), typeOfCourse.value);
	cal.createSchedules([
		{
			id: '3',
			calendarId: '1',
...
// 		category: 'time',
// 		dueDateClass: '',
// 		start: '2021-01-07T22:30:00+09:00',
// 		end: '2021-02-12T02:30:00+09:00',
// 		body: 'lorem is cool!'
// 	},
// 	{
// 		id: '2',
